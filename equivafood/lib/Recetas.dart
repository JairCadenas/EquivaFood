...
const List<Receta> _recetas = [
  ...
  Receta(
    ...
    ingredientes: [
      '150g de yogurt griego natural sin azúcar',
      '5 almendras enteras',
    ],
    pasos: [
  ...
  Receta(
    ...
    ingredientes: [
      '60g de queso panela en rebanadas',
      '1 nopal mediano limpio',
      'Sal y orégano',
    ],
    pasos: [
  ...
  Receta(
    ...
    tags: ['gluten', 'nuez'],
    icono: Icons
        .soup_kitchen_outlined, // Corregido para evitar errores de compatibilidad
    ingredientes: [
      '½ taza de avena en hojuelas',
      '1 taza de leche de almendras',
      '½ taza de fruta picada (fresa o plátano)',
      'Canela al gusto',
    ],
    pasos: [
  ...
  Receta(
    ...
    ingredientes: [
      '1 scoop de proteína vegetal en polvo',
      '1 plátano maduro',
  ...
  Receta(
    ...
    ingredientes: [
      '2 tortillas de maíz horneadas en tótopos',
      '½ taza de salsa verde casera templada',
  ...
  Receta(
    ...
    pasos: [
      'Sirve las porciones en un recipiente pequeño y consúmelas de manera directa como snack.',
    ],
  ),
  Receta(
    ...
    icono: Icons.restaurant_menu,
    ingredientes: [
      '1 taza de jícama picada en cubos o bastones',
      'Jugo de 1 limón',
      'Sal al gusto',
    ],
    pasos: [
      'Coloca la jícama picada en un tazón, agrega el jugo de limón, sal y revuelve bien.',
    ],
  ),
  Receta(
    ...
    pasos: [
      'Lava perfectamente la fruta con abundante agua y consúmela fresca entera o en gajos.',
    ],
  ),
  Receta(
    ...
    pasos: [
      'Desmolda la gelatina fría del refrigerador y consume directamente con una cuchara.',
    ],
  ),
  Receta(
    ...
    pasos: [
      'Lava y pela el pepino, córtalo en rodajas, colócalo en un plato y sazona con limón y chile.',
    ],
  ),
  Receta(
  ...
  Receta(
    ...
    pasos: [
      'Lava y corta la zanahoria en tiras delgadas. Sírvelas en un plato plano junto con el hummus para dipear.',
    ],
  ),
  Receta(
    ...
    ingredientes: [
      '1 manzana en gajos',
      '1 cucharada de mantequilla de maní pura',
    ],
    pasos: [
      'Corta la manzana limpia en rodajas y úntales una porción controlada de mantequilla de maní.',
    ],
  ),
  Receta(
    ...
    pasos: [
      'Unta el aguacate sobre las galletas de arroz y añade una pizca de sal.',
    ],
  ),
  Receta(
    ...
    pasos: [
      'Mezcla ambas semillas en un contenedor pequeño para consumirlas juntas como snack crocante.',
    ],
  ),
  ...
  Receta(
    ...
    ingredientes: [
      '120g de filete de pescado blanco',
  ...
  Receta(
    ...
    ingredientes: [
      '120g de filete de salmón',
      '5 espárragos limpios',
  ...
  Receta(
    ...
    ingredientes: [
      ...
      '½ taza de jitomate y cebolla en cubos',
  ...
  Receta(
    ...
    icono: Icons.restaurant,
    ingredientes: [
      '120g de pechuga de pollo fileteada',
  ...
  Receta(
    ...
    icono: Icons.dinner_dining,
    ingredientes: [
      '1 medallón de frijol negro preparado',
      '1 pan integral para hamburguesa',
      'Hojas de lechuga y jitomate',
    ],
    pasos: [
  ...
  Receta(
    ...
    icono: Icons.set_meal_outlined,
    ingredientes: [
      '120g de camarones limpios',
      '1 taza de calabacita y brócoli picados',
      '1 cdita de aceite',
    ],
    pasos: [
  ...
  Receta(
    ...
    icono: Icons.dinner_dining,
    ingredientes: [
      '1 taza de cereal integral alto en fibra',
      '1 taza de leche descremada o light',
    ],
    pasos: [
      'Sirve el cereal en un plato hondo y baña con la taza de leche light fría.',
    ],
  ),
  Receta(
    ...
    ingredientes: [
      ...
      '60g de queso cottage bajo en grasa',
    ],
    pasos: [
  ...
  Receta(
    ...
    ingredientes: [
      ...
      '½ taza de verduras mixtas en cubos',
  ...
  Receta(
    ...
    tags: ['gluten'],
    icono: Icons
        .restaurant, // Corregido: Reemplazado por un icono nativo compatible
    ingredientes: [
  ...
  Receta(
    ...
    icono: Icons.dinner_dining,
    ingredientes: [
      '2 tostadas de maíz horneadas crujientes',
      '½ taza de frijoles de la olla machacados',
      '1 nopal asado',
    ],
    pasos: [
  ...
  Receta(
    ...
    pasos: [
      'Combina los garbanzos y el pepino fresco en un recipiente, añade jugo de limón y revuelve bien.',
    ],
  ),
  Receta(
...
String convertirAnalisisDeGramos(String ingrediente) {
  ...
  if (text.contains('1 taza de leche'))
    return '$ingrediente (aprox. 240g o ml)';
  ...
  if (text.contains('1 taza de granos de elote'))
    return '$ingrediente (aprox. 160g)';
  ...
  if (text.contains('1 cucharada de mantequilla'))
    return '$ingrediente (aprox. 16g)';
  if (text.contains('2 cucharadas de hummus'))
    return '$ingrediente (aprox. 30g)';
  ...
  if (text.contains('¼ de aguacate') || text.contains('¼ aguacate'))
    return '$ingrediente (aprox. 25g)';
  ...
  Widget build(BuildContext context) {
    ...
    try {
      recetaEncontrada = _recetas.firstWhere(
        (r) =>
            r.nombre.toLowerCase().trim().contains(
              alimentoOrigen!.toLowerCase().trim(),
            ) ||
            alimentoOrigen!.toLowerCase().trim().contains(
    ...
    return Scaffold(
      ...
      body: recetaEncontrada == null
          ? _buildRecetaAutomatica(
              alimentoOrigen ?? 'Alimento alternativo',
              primaryColor,
            )
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ...recetaEncontrada.ingredientes.map(
                            (ing) => Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      convertirAnalisisDeGramos(
                                        ing,
                                      ), // Invocación segura de gramos
                                      style: const TextStyle(
                                        fontSize: 13,
                                        color: Colors.black87,
                                      ),
                          ...
                          ...recetaEncontrada.pasos.asMap().entries.map(
                            (e) => Padding(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Guía rápida generada por la app',
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    '• 1 porción controlada de: $nombreAlimento',
                    style: const TextStyle(fontSize: 13),
                  ),
                  const Text(
                    '• Condimentos libres (sal, pimienta, limón al gusto)',
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    '1. Desinfecta e higieniza tus insumos y manos antes de iniciar.',
                    style: TextStyle(fontSize: 13),
                  ),
                  const Text(
                    '2. Pesa la cantidad indicada en tu plan original para mantener las equivalencias.',
                    style: TextStyle(fontSize: 13),
                  ),
                  const Text(
                    '3. Cocina a la plancha o al vapor evitando el exceso de aceites añadidos.',
                    style: TextStyle(fontSize: 13),
                  ),
                ],
              ),
